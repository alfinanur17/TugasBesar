...
<form method="POST" action="{{ route('login') }}">
                        @csrf
<input id="username" type="username" class="input100 @error('username') 
...
<input id="password" type="password" class="input100 @error('password')
...
<div class="login100-more" style="background-image: url('images/bunga.jpg');">
</div>
</div>
</div>
</div>
