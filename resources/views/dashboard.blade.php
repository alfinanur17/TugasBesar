  ...
  <body>
    ...
    <header class="">
      <nav class="navbar navbar-expand-lg">
        <div class="container">
          <a class="navbar-brand" href="/dashboard"><h2>Flower<em>House</em></h2></a>
        ...
        <div class="row">
          ...
          <div class="col-md-4">
            <div class="product-item">
              <a href="#"><img src="assets/images/bucket1 (1).jpg" alt=""></a>
              <div class="down-content">
                <a href="#"><h4>Bucket 1</h4></a>
                <h6>Rp. 300.000</h6>
          ...
          <div class="col-md-4">
            <div class="product-item">
              <a href="#"><img src="assets/images/bucket2.jpg" alt=""></a>
              <div class="down-content">
                <a href="#"><h4>Bucket 2</h4></a>
                <h6>Rp. 300.000</h6>
                <p>Lorem ipsume dolor sit amet, adipisicing elite. Itaque, corporis nulla aspernatur.</p>
                <ul class="stars">
                  <li><i class="fa fa-star"></i></li>
          ...
          <div class="col-md-4">
            <div class="product-item">
              <a href="#"><img src="assets/images/bucket3.jpg" alt=""></a>
              <div class="down-content">
                <a href="#"><h4>Bucket 3</h4></a>
                <h6>Rp. 250.000</h6>
          ...
          <div class="col-md-4">
            <div class="product-item">
              <a href="#"><img src="assets/images/bucket44.png" alt=""></a>
              <div class="down-content">
                <a href="#"><h4>Bucket 4</h4></a>
                <h6>Rp. 275.000</h6>
                <p>Lorem ipsume dolor sit amet, adipisicing elite. Itaque, corporis nulla aspernatur.</p>
                <ul class="stars">
                  <li><i class="fa fa-star"></i></li>
          ...
          <div class="col-md-4">
            <div class="product-item">
              <a href="#"><img src="assets/images/bucket5.jpg" alt=""></a>
              <div class="down-content">
                <a href="#"><h4>Bucket5</h4></a>
                <h6>Rp. 250.000</h6>
                <p>Lorem ipsume dolor sit amet, adipisicing elite. Itaque, corporis nulla aspernatur.</p>
                <ul class="stars">
                  <li><i class="fa fa-star"></i></li>
          ...
          <div class="col-md-4">
            <div class="product-item">
              <a href="#"><img src="assets/images/bucket6.jpg" alt=""></a>
              <div class="down-content">
                <a href="#"><h4>Bucket6</h4></a>
                <h6>Rp. 300.000</h6>
                <p>Lorem ipsume dolor sit amet, adipisicing elite. Itaque, corporis nulla aspernatur.</p>
                <ul class="stars">
                  <li><i class="fa fa-star"></i></li>
      ...
      <div class="container">
        <div class="row">
          ...
          <div class="col-md-6">
            ...
            <p><a>FLOWER HOUSE</a> Toko bunga ini didirikan pada tahun 2019 untuk mempermudah pengguna dalam menccari bunga secara online. <a rel="nofollow" href="/contact">Contact us</a> for more info.</p>
